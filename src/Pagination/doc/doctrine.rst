...
Cursor fields must be mapped scalar fields on the root entity.
Associations, unmapped aliases and user-provided field names are
rejected. Supported Doctrine types include integer, string, GUID, float,
decimal, boolean and date/time fields.
