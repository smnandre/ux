...
That's it! If you want the options to be autocompleted via Ajax, pass a `url` value, which works well if you create a `custom autocompleter <custom-autocompleter>`:
